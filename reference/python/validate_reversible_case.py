...
def validate_case_card(card: Any) -> None:
    ...
    _required(program, "loading.program", "boundary", "initial_increment_mm", "maximum_displacement_mm", "endpoint", "newton")
    _equal(program["boundary"], "loaded", "loading.program.boundary")
    _number(program["initial_increment_mm"], 0.001, "loading.program.initial_increment_mm")
    _number(program["maximum_displacement_mm"], 1.0, "loading.program.maximum_displacement_mm")
